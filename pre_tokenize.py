...
train = json.load(open('annotations2017/captions_train2017.json'))
val = json.load(open('annotations2017/captions_val2017.json'))
...
json.dump(train, open('annotations2017/captions_train2017_tokenized.json', 'w'))
...
print('val tokenize')
tokenize(val)
json.dump(val, open('annotations2017/captions_val2017_tokenized.json', 'w'))
